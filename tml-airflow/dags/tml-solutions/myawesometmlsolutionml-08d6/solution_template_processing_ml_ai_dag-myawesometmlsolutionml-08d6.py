...
step3 = importlib.import_module("tml-solutions.myawesometmlsolutionml-08d6.tml_read_LOCALFILE_step_3_kafka_producetotopic_dag-myawesometmlsolutionml-08d6")
...
with DAG(
    dag_id="solution_preprocessing_ml_ai_dag-myawesometmlsolutionml-08d6",
